import reducer, { initialState } from 'src/store/coin/reducer';
import {
  fetchGlobalCryptoActions,
  fetchAllCoinsActions,
  fetchSpecificCoinActions,
  setIsLoadingCoins,
  setCoinsFiltered } from 'src/store/coin/actions';
import { CoinMock, GlobalDataMock } from 'src/factory/coins';
import { AllCoinsResponse } from 'src/models';
