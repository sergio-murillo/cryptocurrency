import reducer, { initialState } from 'src/store/exchange/reducer';
import {
  fetchAllExchangesActions,
  fetchExchangeForCoinActions,
  setIsLoadingExchanges,
  setExchangesFiltered } from 'src/store/exchange/actions';
import { AllExchangeMock, ExchangeMock } from 'src/factory/exchanges';
import { ExchangeResponse } from 'src/models';
